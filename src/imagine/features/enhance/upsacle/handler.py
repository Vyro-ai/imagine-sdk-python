...
class UpscaleHandler:
    """
    The UpscaleHandler class is responsible for performing image
    ...
    __client: HttpClient
    __endpoint: str = "/enhance/upscale"
    ...
    def __call__(self, image_path: str) -> Response[Image]:
        ...
        status_code, content = self.__client.post(self.__endpoint, files)
        if status_code != 200:

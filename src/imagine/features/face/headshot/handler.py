...
class HeadshotHandler:
    """
    The HeadshotHandler class is responsible for changing the subject's clothes
    using the Imagine API's image headshot endpoint.
    """

    __client: HttpClient
    __endpoint: str = "/face/headshot"
    ...
    def __call__(self, image_path: str, prompt: str) -> Response[Image]:
        ...
        parameters = parameter_builder(prompt=prompt)
